...
This guide walks through setting up Prerender.io to serve fully-rendered HTML to search crawlers for bradfordblockeddrains.co.uk.
...
3. Add site: `https://bradfordblockeddrains.co.uk`
...
2. Add route: `bradfordblockeddrains.co.uk/*`
...
2. Enter: `https://bradfordblockeddrains.co.uk/services/blocked-drains`
3. Verify:
...
curl -A "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)" \
  -I https://bradfordblockeddrains.co.uk/services/blocked-drains

# Check if Prerender served the response (via headers)
curl -A "Googlebot" https://bradfordblockeddrains.co.uk/ -D -

# View full prerendered HTML
curl -A "Googlebot" https://bradfordblockeddrains.co.uk/services/blocked-drains
```
...
curl -X POST https://api.prerender.io/recache \
  ...
  -d '{"prerenderToken": "YOUR_TOKEN", "url": "https://bradfordblockeddrains.co.uk/page"}'
```
