...
- [ ] Fetch `https://bradfordblockeddrains.co.uk/sitemap.xml` - confirm HTTP 200
...
- [ ] Fetch `https://bradfordblockeddrains.co.uk/robots.txt` - confirm HTTP 200
...
- [ ] Fetch `https://bradfordblockeddrains.co.uk/llm.html` - confirm HTTP 200
...
- [ ] Submit sitemap at `https://bradfordblockeddrains.co.uk/sitemap.xml`
