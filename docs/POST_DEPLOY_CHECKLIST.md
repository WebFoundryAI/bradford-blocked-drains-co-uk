...
- [x] https://bradfordblockeddrains.co.uk/sitemap.xml returns 200
- [x] https://bradfordblockeddrains.co.uk/robots.txt returns 200
...
### Validate robots.txt
- [x] Contains `Sitemap: https://bradfordblockeddrains.co.uk/sitemap.xml`
...
- [x] Location (`/locations/bradford`)
- [x] Location + service (`/locations/bradford/blocked-drains`)
- [x] About (`/about`)
- [x] Contact (`/contact`)
...
- [x] Add property: `bradfordblockeddrains.co.uk`
...
```bash
# Test sitemap
curl -s https://bradfordblockeddrains.co.uk/sitemap.xml | head -20

# Test robots.txt
curl https://bradfordblockeddrains.co.uk/robots.txt

# Test homepage canonical
curl -s https://bradfordblockeddrains.co.uk/ | grep -i 'rel="canonical"'

# Test homepage title
curl -s https://bradfordblockeddrains.co.uk/ | grep -i '<title>'
```
