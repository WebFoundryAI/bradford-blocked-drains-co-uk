export const ABOUT_CONTENT = `Bradford helps homes and businesses across Bradford with all types of drainage problems. Our skilled engineers fix everything from simple blockages to broken pipes and full drain repairs. We have built our reputation on honest work, clear communication, and reliable results.
...
export const SERVICES_OVERVIEW = `At Bradford, we provide a comprehensive range of professional drainage services designed to meet the needs of residential and commercial properties throughout Bradford and surrounding areas. Our experienced team is equipped with the latest technology and expertise to handle everything from minor blockages to complex drainage issues, ensuring your property's drainage system operates efficiently and reliably.`;

export const HOME_INTRO = `Need a drainage team you can trust in Bradford? We provide fast, clear, and professional help for blocked drains, drain cleaning, CCTV surveys, and repairs. We explain the issue in plain English, confirm the price before work starts, and aim to solve the problem on the first visit whenever possible. From small household blockages to urgent drainage emergencies, our local engineers are ready 24/7 across Bradford and surrounding areas.`;
  ...
  faqs: [
    {
      ...
      answer: "For online form submissions, we aim to call you back within 30 minutes during business hours. For phone enquiries, you speak to our team immediately. Emergency callouts are dispatched straight away, with engineers typically arriving within 60 to 90 minutes across Bradford and surrounding areas."
    },
    {
